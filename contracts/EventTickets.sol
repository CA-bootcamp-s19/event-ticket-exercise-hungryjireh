...
contract EventTickets {
    ...
    */
    ...
    event LogGetRefund(address refundRequester, uint ticketsRefunded);
    ...
    */
    function buyTickets(uint numberTickets) public payable {
        ...
        require(msg.value >= numberTickets * TICKET_PRICE);
        require(myEvent.totalTickets >= numberTickets);
        myEvent.buyers[msg.sender] += numberTickets;
        myEvent.totalTickets -= numberTickets;
        myEvent.sales += numberTickets;
        msg.sender.transfer(msg.value - (numberTickets * TICKET_PRICE));
    ...
    */
    function getRefund() public {
        ...
        msg.sender.transfer(numberTickets * TICKET_PRICE);
